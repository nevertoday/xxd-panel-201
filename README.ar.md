...
# XXD Panel 201｜مجسم يدوي مصغر بدرجات كريمية
...
بعد التثبيت أعد تشغيل جلسة Agent ثم استدعِ `$xxd-panel-201`. ويمكن إضافة `--global --agent codex --yes` للتثبيت على مستوى المستخدم.

```text
/xxd-panel-201 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale ar-SA
...
راجع [SKILL.md](SKILL.md) لعقد التشغيل الكامل، ومهايئ التشغيل [بالإنجليزية](references/xxd-panel-201-prompt.en.md) أو [بالصينية](references/xxd-panel-201-prompt.zh-CN.md).
...
- `design-only`: تعرض اللوحة الكاملة ترجمة Panel 201 التصميمية فقط، وتبقى الصورة مرجعاً غير ظاهر.
